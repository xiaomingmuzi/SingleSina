        ...
        OKHttpUtil.httpGet(params, new IOKCallBack() {
            ...
            public void onException(Exception e) {
                if (NetWorkHelper.isNetActive())
                    ToastUtils.getInstance(getContext()).showToast(getString(R.string.data_error));
                else ToastUtils.getInstance(getContext()).showToast(getString(R.string.net_error));
            }
